...
void CalibrationInit(void)
{
  ...
  data1.d32 = BSP_BACKUP_RestoreParameter(RTC_BKP_DR0);
  data2.d32 = BSP_BACKUP_RestoreParameter(RTC_BKP_DR1);
  ...
  if(data2.b.IsCalibrated == 0)
  {
    ...
    data1.b.A1 = A1;
    data1.b.B1 = B1;
    BSP_BACKUP_SaveParameter(RTC_BKP_DR0, data1.d32);
    
    data2.b.A2 = A2;
    data2.b.B2 = B2;
    data2.b.IsCalibrated = 1;
    BSP_BACKUP_SaveParameter(RTC_BKP_DR1, data2.d32);  
...
uint8_t CalibrationIsDone(void)
{
  return CALIBRATION_Done;
}

uint16_t CalibrationGetX(uint16_t x)
{
  return (((A1 * x) + B1)/1000);
}

uint16_t CalibrationGetY(uint16_t y)
{
  return (((A2 * y) + B2)/1000);
}
/*************************** End of file ****************************/
