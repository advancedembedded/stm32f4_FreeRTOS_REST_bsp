...
#define ID_BUTTON_12_HOUR (GUI_ID_USER + 0x0E)
#define ID_BUTTON_24_HOUR (GUI_ID_USER + 0x0F)
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] =
{
    ...
    { TEXT_CreateIndirect, "CLOCK FORMAT", ID_TEXT_HEADER, 0, 0, 480, 50, 0, 0x64, 0 },
    { BUTTON_CreateIndirect, "12 Hour", ID_BUTTON_12_HOUR, 120, 80, 240, 40, 0, 0x0, 0 },
    { BUTTON_CreateIndirect, "24 Hour", ID_BUTTON_24_HOUR, 120, 151, 240, 40, 0, 0x0, 0 },
};
...
static void _cbDialog(WM_MESSAGE * pMsg)
{
    ...
    case WM_INIT_DIALOG:
        ...
        // Initialization of 'Button'
        //
        hItem = WM_GetDialogItem(pMsg->hWin, ID_BUTTON_12_HOUR);
        BUTTON_SetFont(hItem, GUI_FONT_20B_1);
        BUTTON_SetTextColor(hItem, 0, GUI_MAKE_COLOR(0x00FFFFFF));
        //
        // Initialization of 'Button'
        //
        hItem = WM_GetDialogItem(pMsg->hWin, ID_BUTTON_24_HOUR);
        BUTTON_SetFont(hItem, GUI_FONT_20B_1);
        BUTTON_SetTextColor(hItem, 0, GUI_MAKE_COLOR(0x00FFFFFF));
        break;
    case WM_NOTIFY_PARENT:
        ...
        case ID_BUTTON_SAVE: // Notifications sent by 'Button'
            ...
            break;
        case ID_BUTTON_12_HOUR: // Notifications sent by 'Button'
            switch(NCode)
            {
            case WM_NOTIFICATION_CLICKED:
                break;
            ...
            break;
        case ID_BUTTON_24_HOUR: // Notifications sent by 'Button'
            switch(NCode)
            {
            case WM_NOTIFICATION_CLICKED:
                break;
