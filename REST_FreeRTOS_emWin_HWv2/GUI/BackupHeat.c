...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] =
{
    ...
    { BUTTON_CreateIndirect, "Button", ID_BUTTON_CANCEL, 20, 229, 75, 24, 0, 0x0, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg)
{
    ...
    case WM_NOTIFY_PARENT:
        ...
        case ID_BUTTON_SAVE: // Notifications sent by 'Button'
            ...
            break;
        case ID_BUTTON_YES: // Notifications sent by 'Button'
            switch(NCode)
            {
            ...
            break;
        case ID_BUTTON_NO: // Notifications sent by 'Button'
            switch(NCode)
            {
            case WM_NOTIFICATION_CLICKED:
                break;
